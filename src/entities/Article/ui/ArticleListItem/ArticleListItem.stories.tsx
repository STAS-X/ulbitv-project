...
export const ArticleListItemTile = Template.bind({});
ArticleListItemTile.args = {
	children: 'Text primary',
	view: ArticleView.TILE
};

export const ArticleListItemTileDark = Template.bind({});
ArticleListItemTileDark.args = {
	children: 'Text secondary',
	view: ArticleView.TILE
};
ArticleListItemTileDark.decorators = [ThemeDecorator(Theme.DARK)];
