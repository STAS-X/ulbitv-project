import { ArticleBlockType, ArticleTextBlock } from '../../../model/types/articleSchema';
...
/**
 * Компонент устарел, используем новый компонент из корня
 * @depricated
 */

export const ArticleListItemDeprecated: FC<ArticleListItemProps> = memo((props: ArticleListItemProps) => {
